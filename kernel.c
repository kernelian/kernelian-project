...
void kmain(void) {
    ...
    print("create <filename> <file content> - Create a file with file context, make sure to not add any spaces in the filename, because it would be registered as file content! Use dashes instead.\n", &offset);
